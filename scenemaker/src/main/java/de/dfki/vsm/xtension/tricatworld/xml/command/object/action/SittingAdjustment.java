 ...
 *
 */
public class SittingAdjustment extends TriCatWorldActObject implements XMLParseable, XMLWriteable {

    String mX = "";
    String mY = "";
    String mZ = "";

    public SittingAdjustment(String x, String y, String z) {
        mName = "sitrotationoffset";
        mX = x;
        mY = y;
        mZ = z;
    }

    public SittingAdjustment() {
    }
