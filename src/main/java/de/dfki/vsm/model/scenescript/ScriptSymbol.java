 ...
 */
public final class ScriptSymbol extends SyntaxDocSymbol implements ScriptFields {

    // The System Logger
    public static LOGDefaultLogger sLogger = LOGDefaultLogger.getInstance();
    // The Array With Field Names
    public static String[] sFieldNames;
    // The Array With State Names
    public static String[] sStateNames;
