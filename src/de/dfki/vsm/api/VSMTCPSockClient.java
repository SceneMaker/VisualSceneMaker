...
public final class VSMTCPSockClient extends VSMAgentClient {
    ...
    public VSMTCPSockClient(
        ...
        mLogger.message("Creating TCP Agent Client For '"
                + name + "' With Id '" + uaid + "' On '" + rhost + ":" + rport + "'");
    }
    ...
    public final void start() {
        try {
            ...
            // Debug Some Information
            mLogger.message("Constructing TCP Agent Client For '"
    ...
    public final void run() {
        // Debug Some Information
        mLogger.message("Starting TCP Agent Client For '"
                + mAgentName + "' With Id '" + mAgentUaid + "' On '" + mRemoteHost + ":" + mRemotePort + "'");
        ...
        // Debug Some Information
        mLogger.message("Stopping TCP Agent Client For '"
                + mAgentName + "' With Id '" + mAgentUaid + "' On '" + mRemoteHost + ":" + mRemotePort + "'");
    }
        ...
        if (mInput != null) {
            try {
                ...
                mLogger.message("Reading Message'" + BINUtilities.BytesToHexString(bytes)
                        + "' From TCP Agent Client '" + mAgentName + "' With Id '" + mAgentUaid + "'");
