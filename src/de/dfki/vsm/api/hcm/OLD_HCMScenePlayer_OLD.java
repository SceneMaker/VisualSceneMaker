...
//
//
//import de.dfki.vsm.api.VSMTCPClient;
...
// */
//public class OLD_HCMScenePlayer_OLD extends VSMScenePlayer {
//    
//    // the player instance
//    public static OLD_HCMScenePlayer_OLD sInstance;
//    //public static HCMScenePlayer sInstance;
//    
//    // the event handler (hides original SSI Event handler)
//    protected OLD_SSIEventHandler_OLD mEventHandler;
//    
//    
//    
//    //==========================================================================
...
//    //==========================================================================
//    
//    public static synchronized OLD_HCMScenePlayer_OLD getInstance(final ProjectData project) {
//        if (sInstance == null) {
//            sInstance = new OLD_HCMScenePlayer_OLD(project);
//        }
//
//        return sInstance;
//    }
...
//    protected OLD_HCMScenePlayer_OLD(final ProjectData project) {
//        super(project);  
//    }
//
...
//        //----------------------------------------------------------------------
//        mEventHandler = new OLD_SSIEventHandler_OLD(this);
//        
...
//     */
//    public final void request(String name, String type, Task task, long time, String text, VSMTCPClient client) {
//        try {
...
//     */
//    @Override
//    public final void handle(VSMTCPClient client) {
//        try {
...
//                // Parse the message
//                //------------------------------------------------------------------
//                HCMEventMessage parsedMessage = new HCMEventMessage(message);
