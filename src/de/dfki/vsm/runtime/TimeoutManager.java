...
public class TimeoutManager {
    ...
    ///////////////////////////////////////////////////////////////////////////
    public void startTimeoutHandler(VarDef def, Environment env) throws RunTimeException {
    ...
    public void startTimeoutHandler(Expression exp, Environment env) throws RunTimeException {
        if (exp instanceof List) {
            ...
            if (value.getType() == AbstractValue.Type.INT) {
                ...
                throw new RunTimeException(this, "timeout argument not integer");
            }
