            ...
            public void run() {
                for (SceneTurn turn : scene.getTurnList()) {
                    ...
                    for (SceneUttr uttr : turn.getUttrList()) {
                        // check if there is any text to speak - if not just schedule the activities added PG 20.4.2016 
                        String textonly = uttr.getCleanTextOnly();
