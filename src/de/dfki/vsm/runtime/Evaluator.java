...
import de.dfki.vsm.runtime.value.DoubleValue;
...
import de.dfki.vsm.runtime.value.LongValue;
import de.dfki.vsm.runtime.value.ObjectValue;
...
//    }
    ...
    public void execute(final Command cmd, final Environment env) throws RunTimeException {
        ...
        ////////////////////////////////////////////////////////////////////
            ...
            throw new RunTimeException(cmd,
                    "'" + cmd.getConcreteSyntax() + "' cannot be executed");
        }//
        ////////////////////////////////////////////////////////////////////
        ...
        ////////////////////////////////////////////////////////////////////
            ...
            ////////////////////////////////////////////////////////////////////
                ...
                env.write(
                        ((MemVarExp) lexp).getName(),
                        ((MemVarExp) lexp).getMemberName(),
                        evaluate(rexp, env));
            }//
            ////////////////////////////////////////////////////////////////////
            // Assignment
     ...
     */
    public void declare(VarDef def, Environment env) throws RunTimeException {
     ...
     * ************************************************************************
     */
    public AbstractValue evaluate(Expression exp, Environment env) throws RunTimeException {
        ////////////////////////////////////////////////////////////////////
        // CONSTANT EXPRESSION
        ////////////////////////////////////////////////////////////////////
        ...
        ////////////////////////////////////////////////////////////////////
            ...
            if (operator == BinaryExp.Operator.Add) {
                if (left instanceof IntValue && right instanceof IntValue) {
                    ...
                    return new StringValue(
                            ((StringValue) left).getValue()
                            + ((BooleanValue) right).booleanValue());
        ...
        ////////////////////////////////////////////////////////////////////
            ...
            if (index.getType() == AbstractValue.Type.INT) {
                return env.read(
                        ((ArrVarExp) exp).getName(),
                        ((IntValue) index).getValue());
            } else {
                throw new RunTimeException(exp,
                        "'" + exp.getConcreteSyntax() + "' cannot be evaluated");
            }
        ...
        ////////////////////////////////////////////////////////////////////
            ...
            return env.read(
                    ((MemVarExp) exp).getName(),
                    ((MemVarExp) exp).getMemberName());
        }//
        ////////////////////////////////////////////////////////////////////
        // BINARY CONDITIONS
        ////////////////////////////////////////////////////////////////////
        ...
        ////////////////////////////////////////////////////////////////////
            ...
            SystemHistory.Entry entry = mInterpreter.getSystemHistory().get(
                    ((HistoryContainsState) exp).getState(),
                    ((HistoryContainsState) exp).getDepth());
            if (entry == null) {
                return new BooleanValue(false);
            } else {
                return new BooleanValue(
                        entry.containsChildNode(((HistoryContainsState) exp).getSubState()));
            }
        }//
        ////////////////////////////////////////////////////////////////////
        //  HISTORY VALUE OF
        ////////////////////////////////////////////////////////////////////
            ...
            return mInterpreter.getSystemHistory().get(
                    ((HistoryValueOf) exp).getNode(),
        ...
        ////////////////////////////////////////////////////////////////////
            ...
            return new IntValue((int) mInterpreter.getSystemHistory().get(
                    ((HistoryRunTimeOf) exp).getNode(),
        ...
        ////////////////////////////////////////////////////////////////////
            ...
            if (result instanceof Boolean) {
                ...
                java.lang.String errorMsg
                        = "An error occured while executing thread " + Process.currentThread().toString() + " : "
                        + "The return value '" + result + "' of the user command call '" + exp.getConcreteSyntax()
                        + "' has an invalid type.";
