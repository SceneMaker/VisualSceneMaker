...
public class Evaluator {
    ...
    // Execute a command
    public final void execute(final Command cmd, final Environment env) throws RunTimeException {
        ...
        ////////////////////////////////////////////////////////////////////
            ...
            throw new RunTimeException(cmd, "'" + cmd.getConcreteSyntax() + "' cannot be executed");
        } //
        ////////////////////////////////////////////////////////////////////
        ...
        ////////////////////////////////////////////////////////////////////
            ...
            try {
                ...
                throw new RunTimeException(env, "Runtime Error: '" + cmd.toString() + "' cannot be evaluated.");
            }
        }
    }
    ...
    public AbstractValue evaluate(Expression exp, Environment env) throws RunTimeException {
        ...
        ////////////////////////////////////////////////////////////////////
            ...
            throw new RunTimeException(exp, "Runtime Error: '" + exp.getAbstractSyntax() + "' cannot be evaluated.");
        }
    }
