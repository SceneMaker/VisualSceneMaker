...
public class StickmanAction extends Action implements AnimationListener {
	...
	public void run() {
		try {
			ScheduledActionPlayer.notifyListenersAboutAction(this, ActionListener.STATE.ACTION_STARTED);
			...
			if (mAnimation == null) {
				...
				ScheduledActionPlayer.notifyListenersAboutAction(this, ActionListener.STATE.ACTION_UNKNOWN);
			} else {
			...
			// notify ScheduledActionPlayer
			ScheduledActionPlayer.actionEnded(this);
