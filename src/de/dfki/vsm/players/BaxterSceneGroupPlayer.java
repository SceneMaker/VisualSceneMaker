 ...
 */
public final class BaxterSceneGroupPlayer implements RunTimePlayer, EventListener {

    // The singelton player instance
    public static BaxterSceneGroupPlayer sInstance = null;
    ...
    private BaxterSceneGroupPlayer() {

    }

    // Get the default scene player instance
    public static synchronized BaxterSceneGroupPlayer getInstance() {
        if (sInstance == null) {
            sInstance = new BaxterSceneGroupPlayer();
        }
        return sInstance;
    }
