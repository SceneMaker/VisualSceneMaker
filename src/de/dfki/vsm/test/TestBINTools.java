...
public class TestBINTools {
    ...
    public static void main(String args[]) {
        try {
            ...
            //
            sLogger.message("x=" + x + "("
                    + BINUtilities.LongToHexString(x) + ","
                    + BINUtilities.LongToOctString(x) + ")");
            sLogger.message("x=" + y + "("
                    + BINUtilities.LongToHexString(y) + ","
                    + BINUtilities.LongToOctString(x) + ")");
            sLogger.message("x=" + z + "("
                    + BINUtilities.LongToHexString(z) + ","
                    + BINUtilities.LongToOctString(x) + ")");
            //
        } catch (Exception exc) {
            exc.printStackTrace();
    ...
    public static void test(String args[]) {
        // The System Logger
        final LOGDefaultLogger sLogger
                = LOGDefaultLogger.getInstance();
        //
        short s = 3645;
        int i = 47484949;
