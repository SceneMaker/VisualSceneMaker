...
public class EditorStarter extends JPanel {
	...
	public EditorStarter(final EditorInstance mParent) {
		...
		mRightProjectBox.setPreferredSize(halfScreenDimension);
		mLeftProjectBox.setBorder(new EmptyBorder(0, 0, 0, 1));
		mRightProjectBox.setBorder(new EmptyBorder(0, 0, 0, 1));
	...
	/**
	 * Creates the list of projects of differnet kinds
	 */
	public void createProjectLists() {
