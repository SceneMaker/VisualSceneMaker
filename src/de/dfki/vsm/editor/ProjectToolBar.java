...
public class ProjectToolBar extends JPanel implements Observer, EventListener, ActionListener {
    ...
    private final ToolBarItem mSuperNodeEntry = new ToolBarItem("Super Node", "Holds Sub-Scences flow", "SUPERNODE_ENTRY", Node.Type.SuperNode);
    private final ToolBarItem mBasicNodeEntry = new ToolBarItem("Basic Node", "Holds Scenes Actions", "BASICNODE_ENTRY", Node.Type.BasicNode);
    private final ToolBarItem mEEdgeEntry = new ToolBarItem("Epsilon Edge", "Creates Epsilon Transition","EEDGE_ENTRY", new Edge(Edge.TYPE.EEDGE));
    private final ToolBarItem mTEdgeEntry = new ToolBarItem("Timeout Edge","Creates Timeout Transition", "TEDGE_ENTRY", new Edge(Edge.TYPE.TEDGE));
    private final ToolBarItem mPEdgeEntry = new ToolBarItem("Probability Edge","Creates Probability Transition", "PEDGE_ENTRY", new Edge(Edge.TYPE.PEDGE));
    private final ToolBarItem mCEdgeEntry = new ToolBarItem("Conditional Edge","Creates Conditional Transition", "CEDGE_ENTRY", new Edge(Edge.TYPE.CEDGE));
    private final ToolBarItem mIEdgeEntry = new ToolBarItem("Interruptive Edge","Creates Interrutive Transition", "IEDGE_ENTRY", new Edge(Edge.TYPE.IEDGE));
    private final ToolBarItem mFEdgeEntry = new ToolBarItem("Fork Edge","Creates Forked Transition", "FEDGE_ENTRY", new Edge(Edge.TYPE.FEDGE));
    private final ToolBarItem mCommentEntry = new ToolBarItem("Comment","Adds a Comment", "COMMENT_ENTRY", new Comment());
