...
//            sBUILDING_BLOCK_NODE_HEIGHT);
    ...
    public static final ArrayList<Integer> sDYNAMIC_KEYS
    ...
    // IMAGE RESSOURCES
    //////////////////////////////////////////////////////////////////////////////
    public static final ImageIcon sSCENEMAKER_LOGO = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/smlogo.png")));
    public static final ImageIcon sSCENEMAKER_DOCICON = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/docicon.png")));
...
//    // public static final ImageIcon sSCENEEDITPROBLEMICON = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/sceneeditproblem.png")));
    public static final ImageIcon sSHOW_GRID_ICON = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/grid.png")));
    public static final ImageIcon sSCREENSHOT_ICON = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/screenshot.png")));
    public static final ImageIcon sVISUALISATIONICON = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/visualisation.png")));
...
//    public static final ImageIcon sDECREASE_ICON = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/decrease.png")));
    public static final ImageIcon sCOMMENT_ENTRY = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/elementtree/COMMENT_ENTRY.png")));
    public static final ImageIcon sSUPERNODE_ENTRY = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/elementtree/SUPERNODE_ENTRY.png")));
    public static final ImageIcon sBASICNODE_ENTRY = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/elementtree/BASICNODE_ENTRY.png")));
    public static final ImageIcon sEEDGE_ENTRY = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/elementtree/EEDGE_ENTRY.png")));
    public static final ImageIcon sTEDGE_ENTRY = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/elementtree/TEDGE_ENTRY.png")));
    public static final ImageIcon sPEDGE_ENTRY = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/elementtree/PEDGE_ENTRY.png")));
    public static final ImageIcon sCEDGE_ENTRY = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/elementtree/CEDGE_ENTRY.png")));
    public static final ImageIcon sIEDGE_ENTRY = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/elementtree/IEDGE_ENTRY.png")));
    public static final ImageIcon sFEDGE_ENTRY = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/elementtree/FEDGE_ENTRY.png")));
    public static final ImageIcon sROOT_FOLDER = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/elementtree/ROOT_FOLDER.png")));
    public static final ImageIcon sSCENE_FOLDER = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/elementtree/SCENE_FOLDER.png")));
    public static final ImageIcon sBASIC_FOLDER = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/elementtree/BASIC_FOLDER.png")));
    public static final ImageIcon sRADIOBUTTON_UNSELECTED = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/elementtree/RADIOBUTTON_UNSELECTED.png")));
    public static final ImageIcon sRADIOBUTTON_SELECTED = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/elementtree/RADIOBUTTON_SELECTED.png")));
   
    public static final ImageIcon sFUNCTION_ENTRY = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/elementtree/FUNCTION_ENTRY.png")));
    public static final ImageIcon sFUNCTION_ERROR_ENTRY = new ImageIcon(Toolkit.getDefaultToolkit().createImage(sSCENEMAKER_CLASS.getResource("/res/img/elementtree/FUNCTION_ERROR_ENTRY.png")));    
    ...
    public static synchronized void configure() {
        try {
            ...
            if (isMac()) {
                ...
                try {
                    Object app = appClass.getMethod("getApplication", new Class[]{}).invoke(null, new Object[]{});
