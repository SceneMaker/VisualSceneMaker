...
public abstract class NodeAction extends EditorAction {
    ...
    public void delete() {
        ...
        HashMap<String, de.dfki.vsm.model.sceneflow.Node> startNodeMap
                = mParentDataNode.getStartNodeMap();
        if (startNodeMap.containsKey(mDataNode.getId())) {
            ...
            if (startNodeMap.isEmpty()) {
                if (mParentDataNode.getNodeList().size() == 0) {
                    if (mParentDataNode.getSuperNodeList().size() == 0) {
                        ...
                        de.dfki.vsm.model.sceneflow.Node newStartNode
                                = mParentDataNode.getSuperNodeAt(0);
