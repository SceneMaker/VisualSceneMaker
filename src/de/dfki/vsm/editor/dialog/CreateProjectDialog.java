        ...
        mLocationTextField.addFocusListener(new FocusListener() {
            ...
            public void focusGained(FocusEvent e) {
                if (!getLocationDialogShownState()) {
                    JFileChooser file = new JFileChooser(mLocationTextField.getText().isEmpty() ? de.dfki.vsm.editor.util.Preferences.sUSER_HOME : mLocationTextField.getText());
...
//        };
    ...
    protected void checkFileConsistency() {
        File sceneFlowFile = new File(mLocationTextField.getText() + System.getProperty("file.separator") + mSceneFlowTextField.getText());
        if (sceneFlowFile.exists()) {
            mSceneFlowMessage.setText("Using existing file at given location!");
        } else {
            mSceneFlowMessage.setText(" ");
        }
        File scenesFile = new File(mLocationTextField.getText() + System.getProperty("file.separator") + mScenesTextField.getText());
    ...
    private void createProject() {
        try {
            ...
            if (mSceneFlowTextField.getText().equalsIgnoreCase(mProjectConfig.property("project.data.sceneflow"))) {
                mSceneFlowFile = new File(mLocationTextField.getText() + System.getProperty("file.separator") + mSceneFlowTextField.getText());
                ...
                mSceneFlowFile = new File(mLocationTextField.getText() + System.getProperty("file.separator") + mProjectConfig.property("project.data.sceneflow"));
            ...
            if (mScenesTextField.getText().equalsIgnoreCase(mProjectConfig.property("project.data.scenes"))) {
                ...
                mScenesFile = new File(mLocationTextField.getText() + System.getProperty("file.separator") + mProjectConfig.property("project.scenes"));
            ...
            if (mGesticonTextField.getText().equalsIgnoreCase(mProjectConfig.property("project.data.gesticon"))) {
                mGesticonFile = new File(mLocationTextField.getText() + System.getProperty("file.separator") + mGesticonTextField.getText());
                ...
                mGesticonFile = new File(mLocationTextField.getText() + System.getProperty("file.separator") + mProjectConfig.property("project.gesticon"));
            ...
            if (mVisiconTextField.getText().equalsIgnoreCase(mProjectConfig.property("project.data.visicon"))) {
                mVisiconFile = new File(mLocationTextField.getText() + System.getProperty("file.separator") + mVisiconTextField.getText());
                ...
                mVisiconFile = new File(mLocationTextField.getText() + System.getProperty("file.separator") + mProjectConfig.property("project.data.visicon"));
