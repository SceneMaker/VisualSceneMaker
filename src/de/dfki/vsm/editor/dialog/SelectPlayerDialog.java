...
public class SelectPlayerDialog extends JDialog {
    ...
    */
    ...
    public void initComponents(){
        ...
        mPreviousButton     = new JButton(Preferences.PREIVOUS_BUTTON);
        mNextButton         = new JButton(Preferences.NEXT_BUTTON);




        mPreviousButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                previousActionPerformed();
            }
        });
        mNextButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                nextActionPerformed();
            }
        });
    ...
    private void previousActionPerformed(){
        if(currentIndex > 0){
            ...
            if(mMissingAgents.size() > 1 && mOkButton.isEnabled()){
                mOkButton.setEnabled(false);
            }
        }else{
            mPreviousButton.setEnabled(false);
