...
public final class SyntaxStylePolicy implements ModelObject {
    ...
    // The Token Style Map
    private final HashMap<String, SyntaxTokenStyle> mStyleMap
            = new HashMap<>();
    ...
    ////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////
    public final int drawStyle(
            Segment segment, int x, int y,
            Graphics graphics, TabExpander e,
            int offset, final String token) {
        // Get The Syntax Style Entry
        final SyntaxTokenStyle entry = mStyleMap.get(token);
        // Set The Font Style Emph 
        final Font font = graphics.getFont().deriveFont(
                (entry.isEmph() ? Font.ITALIC : Font.PLAIN)
                | (entry.isBold() ? Font.BOLD : Font.PLAIN));
        // Set The New Font
