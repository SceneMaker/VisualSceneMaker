...
public class SyntaxEditorView extends PlainView {
    ...
    private final SyntaxStylePolicy mPolicy
            = new SyntaxStylePolicy(SYSUtilities.sSTYLESURL);
    ...
    private int drawDefaultText(
        ...
        for (final SyntaxDocSymbol symbol : list) {
            ...
            x = mPolicy.drawStyle(
                    segment, x, y, graphics2D, this, s, token.getField());
        }
