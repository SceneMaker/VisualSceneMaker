...
public final class NTPMessage {
    ...
    public NTPMessage(byte[] array) {
        ...
        mPrecision     = array[3];
        mRootDelay     = (array[4] * 256.0) + unsignedByteToShort(array[5]) + (unsignedByteToShort(array[6]) / 256.0)
                         + (unsignedByteToShort(array[7]) / 65536.0);
        mRootDispersion = (unsignedByteToShort(array[8]) * 256.0) + unsignedByteToShort(array[9])
    ...
    public String toString() {
        ...
        return "Leap indicator: " + mLeapIndicator + "\n" + "Version: " + mVersionNumber + "\n" + "Mode: " + mode
               ...
               + new DecimalFormat("0.00").format(mRootDelay * 1000) + " ms\n" + "Root dispersion: "
               + new DecimalFormat("0.00").format(mRootDispersion * 1000) + " ms\n" + "Reference identifier: "
               + referenceIdentifierToString(referenceIdentifier, stratum, mVersionNumber) + "\n"
