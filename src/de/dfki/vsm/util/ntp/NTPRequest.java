...
public class NTPRequest {
    ...
    public static String getGlobalTime(final boolean debug) throws IOException {
        ...
        //
        if (debug) {
            System.err.println("Local Computer Time Long: "
        ...
        if (debug) {
            ...
            System.err.println("Destination.timestamp:     "
                    + NTPMessage.timestampToString(destinationTimestamp));
            System.err.println("Round-Trip Delay: "
                    + new DecimalFormat("0.00").format(roundTripDelay * 1000) + " ms");
            System.err.println("Local Clock Offset: "
                    + new DecimalFormat("0.00").format(localClockOffset * 1000) + " ms");
            System.err.println("Global Server Time Date: "
                    + NTPMessage.timestampToString(msg.receiveTimestamp));
            System.err.println("Global Server Time Long: "
                    + NTPMessage.timestampToLong(msg.receiveTimestamp));
        }
