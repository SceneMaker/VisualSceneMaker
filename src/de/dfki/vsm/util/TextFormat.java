...
public class TextFormat {
    ...
    public static TPLTuple<String, AttributedString> fillWithAttributes(String inputString) {
        ...
        while (true) {
            ...
            //
            TPLTuple<Integer, Integer> position = new TPLTuple<Integer, Integer>(
                    unformattedString.length() + preString.length(), unformattedString.length() + preString.length() + subString.length());
            if (c == 'b') {
                // Bold Weight
                TPLTuple<TextAttribute, Object> attribute = new TPLTuple<TextAttribute, Object>(TextAttribute.WEIGHT, TextAttribute.WEIGHT_BOLD);
                attributeMap.put(attribute, position);
            } else if (c == 'i') {
                // Italic Posture
                TPLTuple<TextAttribute, Object> attribute = new TPLTuple<TextAttribute, Object>(TextAttribute.POSTURE, TextAttribute.POSTURE_OBLIQUE);
                attributeMap.put(attribute, position);
            } else if (c == 'r') {
                // Reserved Words
                TPLTuple<TextAttribute, Object> attribute1 = new TPLTuple<TextAttribute, Object>(TextAttribute.FOREGROUND, Color.BLUE);
                TPLTuple<TextAttribute, Object> attribute2 = new TPLTuple<TextAttribute, Object>(TextAttribute.WEIGHT, TextAttribute.WEIGHT_BOLD);
                ...
                // Constant Literals
                TPLTuple<TextAttribute, Object> attribute = new TPLTuple<TextAttribute, Object>(TextAttribute.FOREGROUND, Color.RED.darker());
                attributeMap.put(attribute, position);
            } else if (c == 't') {
                // User-Defined Type Names
                TPLTuple<TextAttribute, Object> attribute = new TPLTuple<TextAttribute, Object>(TextAttribute.FOREGROUND, Color.MAGENTA.darker());
                attributeMap.put(attribute, position);
            } else if (c == 'h') {
                // Struct or List Definitions
                TPLTuple<TextAttribute, Object> attribute = new TPLTuple<TextAttribute, Object>(TextAttribute.FOREGROUND, Color.BLACK);
                attributeMap.put(attribute, position);
            } else if (c == 'p') {
                ...
                attributeMap.put(new TPLTuple<TextAttribute, Object>(TextAttribute.FOREGROUND, Color.GREEN.darker().darker().darker()), position);
            }
