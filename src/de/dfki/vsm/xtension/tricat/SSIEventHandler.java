 ...
 */
public final class SSIEventHandler extends Thread {
    ...
    private final TricatExecutor mPlayer;
    ...
    public SSIEventHandler(
            final TricatExecutor player,
