...
public class ActionLoader {
    ...
    public CharamelActObject loadTWorldAnimation(String cmd) {
        ...
        try {
            ...
            for (Constructor con : constructors) {
                ...
                if (params.length == 0) {
                    a = (CharamelActObject) c.getDeclaredConstructor(params).newInstance();
                }
            }
    ...
    public CharamelActObject loadTWorldAnimation(String cmd, String value) {
        CharamelActObject a = null;
            ...
            for (Constructor con : constructors) {
                ...
                if (params.length == 1) {
                    if (params[0].getSimpleName().equalsIgnoreCase("string")) {
                        a = (CharamelActObject) c.getDeclaredConstructor(params).newInstance(value);
                    }
                }
    ...
    public CharamelActObject loadTWorldAnimation(String cmd, String value1, String value2) {
        CharamelActObject a = null;
        ...
        public CharamelActObject loadTWorldAnimation(String cmd, String value1, String value2, String value3) {
        CharamelActObject a = null;
    ...
    public CharamelActObject loadCharamelAnimation(String cmd, LinkedList value1, String value2, String value3) {
        CharamelActObject a = null;
