 ...
 *
 */
public class SetCamera extends CharamelActObject implements XMLParseable, XMLWriteable {
    ...
    public void writeXML(IOSIndentWriter out) throws XMLWriteError {
        ...
        ca.getCommand().setCamera(Integer.parseInt(mCharameAvatarId), Camera.CLOSEUP, 0);
