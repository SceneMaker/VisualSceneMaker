...
public class PlayDialogueAct extends Command {
    ...
    // Construct A Playback Command 
    public PlayDialogueAct(
            final Expression dialogueAct,
            final Vector<Expression> featureList) {
        mDialogueAct = dialogueAct;
    ...
    public final String getAbstractSyntax() {
        ...
        desc += (mDialogueAct != null ? mDialogueAct.getAbstractSyntax() : "");
    ...
    public final String getConcreteSyntax() {
        String desc = "PlayDialogueAct" + " ( ";
        desc += (mDialogueAct != null ? mDialogueAct.getConcreteSyntax() : "");
        for (int i = 0; i < mFeatureList.size(); i++) {
    ...
    public final String getFormattedSyntax() {
        ...
        desc += (mDialogueAct != null ? mDialogueAct.getFormattedSyntax() : "");
        for (int i = 0; i < mFeatureList.size(); i++) {
    ...
    @Override
    public final void writeXML(IndentWriter out) throws XMLWriteError {
