...
public class ConditionalExp extends Expression {
    ...
    public String getAbstractSyntax() {
        return "ConditionalExp( " + (mCondition != null ? mCondition.getAbstractSyntax() : "") + " , "
                + (mThenExp != null ? mThenExp.getAbstractSyntax() : "") + " , "
                + (mElseExp != null ? mElseExp.getAbstractSyntax() : "") + " )";
    }

    public String getConcreteSyntax() {
        return "( " + (mCondition != null ? mCondition.getConcreteSyntax() : "") + " ? "
                + (mThenExp != null ? mThenExp.getConcreteSyntax() : "") + " : "
                + (mElseExp != null ? mElseExp.getConcreteSyntax() : "") + " )";
    }

    public String getFormattedSyntax() {
        return "( " + (mCondition != null ? mCondition.getFormattedSyntax() : "") + " ? "
                + (mThenExp != null ? mThenExp.getFormattedSyntax() : "") + " : "
                + (mElseExp != null ? mElseExp.getFormattedSyntax() : "") + " )";
    }
