...
public class UnblockSceneGroup extends Command {
    ...
    public String getAbstractSyntax() {
        return "Command(UnblockSceneGroup (" + (mArg != null ? mArg.getAbstractSyntax() : "") + "))";
    }

    public String getConcreteSyntax() {
        return "UnblockSceneGroup ( " + (mArg != null ? mArg.getConcreteSyntax() : "") + " )";
    }

    public String getFormattedSyntax() {
        return "#p#UnblockSceneGroup ( " + (mArg != null ? mArg.getFormattedSyntax() : "") + " )";
    }
