...
public class Abort extends Command {
    ...
    public Abort(Expression arg) {
        System.err.println("ABORTABORT");
        mArg = arg;
        mArgList = new ArrayList<Expression>();
    }

    public Abort(Expression arg, ArrayList<Expression> argList) {
        mArg = arg;
        mArgList = argList;
    }
    ...
    @Override
    public Abort getCopy() {
        return new Abort(mArg.getCopy(), getCopyOfArgList());
    }

    @Override
    public void writeXML(IOSIndentWriter out) throws XMLWriteError {
        out.println("<Abort>").push();
