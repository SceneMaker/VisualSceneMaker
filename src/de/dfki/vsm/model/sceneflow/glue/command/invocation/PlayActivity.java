 ...
 */
public final class PlayActivity extends Invocation {
    ...
    public final String getConcreteSyntax() {
        ...
        String desc = (mMode == PlayMode.Default ? "PlayActivity("
    ...
    public final String getFormattedSyntax() {
        String desc = "#p#" + (mMode == PlayMode.Default ? "PlayActivity ( "
                : (mMode == PlayMode.Sequential ? "!- " : "!= "));
        desc += ((mCommand != null)
    ...
    @Override
    public final PlayActivity getCopy() {
        return new PlayActivity(mCommand.getCopy(), getCopyOfArgList(), mMode);
    }

    @Override
    public final void writeXML(final IOSIndentWriter out) throws XMLWriteError {
        out.println("<PlayActivity mode=\"" + mMode + "\">").push();
        if (mCommand != null) {
