...
public abstract class Expression extends Command {
    ...
    public static Expression parse(final Element element) throws XMLParseError {
        ...
        if (tag.equals("JavaCallExpression")) {
            exp = new JavaCallExpression();
            exp.parseXML(element);
        } else if (tag.equals("JavaNewExpression")) {
            exp = new JavaNewExpression();
            exp.parseXML(element);
        } else if (tag.equals("Neg")
                || tag.equals("Not") || tag.equals("Lnot") || tag.equals("Inc") || tag.equals("Dec")) {
            exp = new UnaryExpression();
            exp.parseXML(element);
        } else if (tag.equals("AndAnd") || tag.equals("OrOr") || tag.equals("And") || tag.equals("Or")
                || tag.equals("Xor") || tag.equals("Add") || tag.equals("Div") || tag.equals("Mul")
                || tag.equals("Mod") || tag.equals("Sub") || tag.equals("Eq") || tag.equals("Ge")
                || tag.equals("Gt") || tag.equals("Le") || tag.equals("Lt") || tag.equals("Neq")) {
            ...
            exp.parseXML(element);
        } else if (tag.equals("InStateCond")) {
            exp = new InStateCond();
            exp.parseXML(element);
        } else if (tag.equals("PrologQuery")) {
            exp = new PrologQuery();
            exp.parseXML(element);
        } else if (tag.equals("TimeoutCond")) {
            exp = new TimeoutCond();
            exp.parseXML(element);
            ...
            exp.parseXML(element);
        } else if (tag.equals("IntLiteral") || tag.equals("FloatLiteral") || tag.equals("BoolLiteral") || tag.equals("StringLiteral") || tag.equals("NullLiteral")) {
            exp = LiteralExpression.parse(element);
        } else if (tag.equals("SimpleVariable") || tag.equals("MemberVariable") || tag.equals("FieldVariable")) {
