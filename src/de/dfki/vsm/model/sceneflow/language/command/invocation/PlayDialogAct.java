 ...
 * @author Not me
 */
public class PlayDialogAct extends Invocation {
    ...
    public PlayDialogAct() {
        mDialogueAct = null;
        mFeatureList = new ArrayList<>();
    }

    // Construct A Playback Command
    public PlayDialogAct(final Expression dialogueAct) {
        mDialogueAct = dialogueAct;
        mFeatureList = new ArrayList<>();
    }

    // Construct A Playback Command
    public PlayDialogAct(final Expression dialogueAct, final ArrayList<Expression> featureList) {
        mDialogueAct = dialogueAct;
    ...
    @Override
    public final PlayDialogAct getCopy() {
        return new PlayDialogAct(mDialogueAct.getCopy(), getCopyOfArgList());
    }
