...
public class VarDef extends Object {
    ...
    public String getAbstractSyntax() {
        return "VarDef(" + mType + "," + mName + "," + (mExp != null ? mExp.getAbstractSyntax() : "") + ")";
    }

    public String getConcreteSyntax() {
        return mType + " " + mName + " = " + (mExp != null ? mExp.getConcreteSyntax() : "");
    }

    public String getFormattedSyntax() {
        return "#r#" + mType + " " + "" + mName + " = " + (mExp != null ? mExp.getFormattedSyntax() : "");
    }

    public VarDef getCopy() {
        return new VarDef(mName, mType, (mExp != null ? mExp.getCopy() : null));
    }
