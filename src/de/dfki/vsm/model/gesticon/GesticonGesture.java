...
public class GesticonGesture implements ModelObject {
    ...
    public GesticonGesture(
            ...
            final boolean blendable,
            final long duration,
            final long preparationEnd,
            final long retractStart,
            final long strokeStart,
            final long strokeEnd) {
    ...
    public final String toScript() {
        return "[ gesture "
                ...
                + "animname=\"" + mAnimName + "\" "
                + "animpath=\"" + mAnimPath + "\" "
                + "blendable=\"" + mBlendable + "\" "
                + "duration=\"" + mDuration + "\" "
                + "preparation-end=\"" + mPreparationEnd + "\" "
                + "retraction-start=\"" + mRetractionStart + "\" "
                + "stroke-phase-start=\"" + mStrokePhaseStart + "\" "
                + "stroke-phase-end=\"" + mStrokePhaseEnd + "\" "
                + "]";
    }
...
////////////////////////////////////////////////////////////////////////////
    ...
    public GesticonGesture getCopy() {
        return new GesticonGesture(
                mCharacter, mAnimName, mAnimPath, mCategory, mBlendable, mDuration,
                mPreparationEnd, mRetractionStart, mStrokePhaseStart, mStrokePhaseEnd);
    }
}
