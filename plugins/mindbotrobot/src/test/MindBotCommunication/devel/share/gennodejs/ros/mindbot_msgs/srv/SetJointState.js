...
class SetJointStateRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('point')) {
        ...
        this.point = new sensor_msgs.msg.JointState();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = sensor_msgs.msg.JointState.serialize(obj.point, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.point = sensor_msgs.msg.JointState.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += sensor_msgs.msg.JointState.getMessageSize(object.point);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.point !== undefined) {
      resolved.point = sensor_msgs.msg.JointState.Resolve(msg.point)
    }
    else {
      resolved.point = new sensor_msgs.msg.JointState()
    }
...
module.exports = {
  ...
  md5sum() { return '2dd47abbafae7d0f1f325f1e048e28c7'; },
  datatype() { return 'mindbot_msgs/SetJointState'; }
};
