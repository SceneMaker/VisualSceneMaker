...
public final class MindbotRobotExecutor extends ActivityExecutor implements MindbotRobotFeedback {
    ...
    public void setDetectedPose(Pose pose) {
        ...
        if(mProject.hasVariable("detected_pose_y")) { mProject.setVariable("detected_pose_y", (float)pos.getY()) ; }
        if(mProject.hasVariable("detected_pose_z")) { mProject.setVariable("detected_pose_z", (float)pos.getZ()) ; }
