...
public class SSIProjectProperty implements ExportableProperties {
    ...
    public SSIProjectProperty() {
        ...
        ProjectProperty loghost = new ProjectProperty("loghost", true,
                ...
                + "the computer");
        ProjectValueProperty loghostVP = new ProjectValueProperty(ValueTYPE.STRING, "127.0.0.1", true);

        ProjectProperty logport = new ProjectProperty("logport", true,
                "Port to connect to SSI.\n "
                + "This field holds the SSI listening port.");
        ProjectValueProperty logportVP = new ProjectValueProperty(ValueTYPE.NUMERIC, 8989, true);

        ProjectProperty logvar = new ProjectProperty("logvar", true,
                "A VSM Sceneflow var that gets messages from SSI");
        ProjectValueProperty logvarVP = new ProjectValueProperty(ValueTYPE.STRING, "SSIMessages", true);

        ProjectProperty pipes = new ProjectProperty("pipes", true,
                "SSI recognition pipeline description");
        ProjectValueProperty pipesVP = new ProjectValueProperty(ValueTYPE.STRING, "interview:127.0.0.1:1111", true);
        ...
        ProjectValueProperty broadcastVP = new ProjectValueProperty(ValueTYPE.BOOLEAN, false);

        ProjectProperty broadcastport = new ProjectProperty("broadcastport",
                "Port on which messages are broadcasted.");
        ProjectValueProperty broadcastportVP = new ProjectValueProperty(ValueTYPE.NUMERIC, 9898);
        ...
        ProjectValueProperty listentostudymasterVP = new ProjectValueProperty(ValueTYPE.BOOLEAN, false);

        ProjectProperty studymasterport = new ProjectProperty("broadcastport",
                "Port on which StudyMaster receives messages.");
        ProjectValueProperty studymasterportVP = new ProjectValueProperty(ValueTYPE.NUMERIC, 9898);
