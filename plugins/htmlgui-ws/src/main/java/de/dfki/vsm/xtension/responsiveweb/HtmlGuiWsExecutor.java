    ...
    public void execute(AbstractActivity activity) throws IOException {
        ...
        if (activity instanceof SpeechActivity) {
            ...
            if (name.equalsIgnoreCase("set")) {
                ...
                try {
                    Process p;
                    p = Runtime.getRuntime().exec("/home/rhythm/Downloads/wetransfer_planarm-software_2021-12-03_1101(1)/planarm_unity(1)/planarm_unity/VisualSceneMaker-mostrecentversion-latestclone/VisualSceneMaker/circle.x86_64");
                } catch (IOException e) {
                ...
                try {
                    Process p;
                    p = Runtime.getRuntime().exec("/home/rhythm/Downloads/wetransfer_planarm-software_2021-12-03_1101(1)/planarm_unity(1)/planarm_unity/VisualSceneMaker-mostrecentversion-latestclone/VisualSceneMaker/infinity_new1.x86_64");
                } catch (IOException e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
                ...
                try {
                    Process p;
                    p = Runtime.getRuntime().exec("/home/rhythm/Downloads/wetransfer_planarm-software_2021-12-03_1101(1)/planarm_unity(1)/planarm_unity/VisualSceneMaker-mostrecentversion-latestclone/VisualSceneMaker/line.x86_64");
